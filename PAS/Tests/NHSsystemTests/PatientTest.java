...
public class PatientTest {
	...
	/**
	 * Test method for True Emergency Condition variable
	 */
	@Test
	public void testIsEmergencyConditionTrue() {
		emergencyCondition = true;
		assertTrue(emergencyCondition);
	}
	
	/**
	 * Test method for False Emergency Condition variable
	 */
	@Test
	public void testIsEmergencyConditionFalse() {
		emergencyCondition = false;
		assertFalse(emergencyCondition);
	}
