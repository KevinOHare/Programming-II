...
public class Queue {
	...
	static PriorityQueue<Patient> pQueue = new PriorityQueue<Patient>(10, new Comparator<Patient>());
	...
	static Patient pat4 = new Patient("Mrs", "Mary", "Kelly", "60 road",
			"Moria", "BT57 092", "689 2583", "3452-039", 1, false);
	...
	public static void main(String[] args)  throws InterruptedException {{
	    PriorityQueue<Patient> pQueue = new PriorityQueue<Patient>(10, new Comparator<Patient>() {
	        public int compare(Patient pat1, Patient pat2) {
	            return (pat1.isEmergencyCase() == pat2.isEmergencyCase()) ? (Integer.valueOf(pat1.getTriage()).compareTo(pat2.getTriage()))
	                                                                              : (pat1.isEmergencyCase() ? -1 : 1);
	        }
	    });
